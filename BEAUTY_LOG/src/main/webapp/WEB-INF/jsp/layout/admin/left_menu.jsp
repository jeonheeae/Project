...
<!-- 		            <div class="logo">
		    ...
		    <div class="sidebar-menu">
		        <ul class="menu">
		            ...
		            <li class="sidebar-item <c:if test="${fn:indexOf(path, 'product/list.do') >-1 }"> active</c:if>">
		                <a href="${pageContext.request.contextPath }/admin/product/list.do" class='sidebar-link'>
