...
<head>
	<title>상품 등록</title>
	<script src="${pageContext.request.contextPath }/js/admin/product/post.js"></script>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>PRODUCT</h3>
                <p class="text-subtitle text-muted">상품 등록</p>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="prdNm" class="form-control" name="prdNm" placeholder="상품명을 입력하세요">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="email-id-vertical">상품설명</label>
                                                <input type="text" id="prdDesc" class="form-control" name="prdDesc" placeholder="상품설명을 입력하세요">
                                            </div>
                                        </div>
